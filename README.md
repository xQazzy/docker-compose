...
git clone https://github.com/xQazzy/crud.git

2. Собрать docker-образ:
docker build -t django_sqlite .

3. Запустить контейнер:
docker run -d -p 8000:8000 django_sqlite


Для проверки работспособности приложения ввести в адресную строку браузера:
localhost:8000